...
function Ayurvedicrangepage(proprange) {
    
        return (
            <div className='container-fluid'>
                <div className=''>
                    <img className='img-fluid' src={require("../../../../assests/images/Ayurvedicrange/Banner.webp")} alt="" />
                </div>
...
export default Ayurvedicrangepage;