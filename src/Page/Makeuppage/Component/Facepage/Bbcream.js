...
function Bbcream() {
    return (
        <div className="container-fluid">
            <div >
                <img className="img-fluid" src={require("../../../../assests/images/Facepage/Banner.webp")} alt="" />
            </div>
                            ...
                            <div className='row  p-2'>
                                <div className='col-lg-4 col-sm-3 '>
                                    <div class="card" style={{ width: '18rem' }}>
                                        <img className='img-fluid' src={require("../../../../assests/images/Facepage/pic1.avif")} class="card-img-top" alt="..." />
                                        <div class="card-body">
