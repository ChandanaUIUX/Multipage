...
function Mascarapage() {
    return (
        <div className="container-fluid">
            <div >
                <img className="img-fluid" src={require("../../../../../assests/images/Masscarapage/Banner.webp")} alt="" />
            </div>
                            ...
                            <div className='row  p-2'>
                                <div className='col-lg-4 col-sm-3 '>
                                    <div class="card" style={{ width: '18rem' }}>
                                        <img className='img-fluid' src={require("../../../../../assests/images/Masscarapage/pic1.webp")} class="card-img-top" alt="..." />
                                        <div class="card-body">
                                ...
                                <div className='col-lg-4 col-sm-3'>
                                    <div class="card" style={{ width: '18rem' }}>
                                        <img className='img-fluid' src={require("../../../../../assests/images/Masscarapage/pic2.webp")} class="card-img-top" alt="..." />
                                        <div class="card-body">
